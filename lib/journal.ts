...
const journalArticleEntries: JournalArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "An Essential Health Check covers the inverter area's physical integrity, switching and safety mechanisms, plus inverter and DB area electrical checks. Electrical Assurance goes further with deeper DC-side safety and performance testing using professional solar testing equipment. Humidity plus load likes to create a warm joint, which is why measurement matters when a deeper electrical picture is required.",
